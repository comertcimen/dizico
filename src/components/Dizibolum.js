...
const Dizibolum = () => {
  ...
  useEffect(() => {
    ...
    const config = {
      headers: {
        Authorization:
          "Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiIwNTU0OGI5ZmRkYzA1YTIzMzYwZTI1ZTgwOTQ1MDg0MSIsInN1YiI6IjVlY2Q1YTMxMDIxY2VlMDAyMThiOThkZSIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.A1j2NgaUXxYUeGy0uRMbeQSEziWq0GoGzL24KyYv3n8",
